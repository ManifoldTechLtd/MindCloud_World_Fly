...
use battle_plugin::BattlePlugin;
...
fn main() {
    ...
    app.add_plugins((MenuPlugin, ScenePlugin, PlacementPlugin, FlightPlugin, GatePlugin, GateEditorPlugin, InputPlugin, AudioPlugin, BattlePlugin));
