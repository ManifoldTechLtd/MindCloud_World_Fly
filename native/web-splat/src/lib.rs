...
pub struct WindowContext {
    ...
    pub animation: Option<(Animation<PerspectiveCamera>, bool)>,
    pub controller: CameraController,
    pub scene: Option<Scene>,
    pub scene_file_path: Option<PathBuf>,
    pub current_view: Option<usize>,
    pub ui_renderer: ui_renderer::EguiWGPU,
    pub fps: f32,
    pub ui_visible: bool,

    #[cfg(not(target_arch = "wasm32"))]
    pub history: RingBuffer<(Duration, Duration, Duration)>,
    pub display: Display,

    pub splatting_args: SplattingArgs,

    pub saved_cameras: Vec<SceneCamera>,
    #[cfg(feature = "video")]
    pub cameras_save_path: String,
    pub stopwatch: Option<GPUStopwatch>,
}

impl WindowContext {
    // Creating some of the wgpu types requires async code
    pub async fn new<R: Read + Seek>(
        window: Window,
        pc_file: R,
    ...
    pub fn resize(&mut self, new_size: winit::dpi::PhysicalSize<u32>, scale_factor: Option<f32>) {
    ...
    pub fn ui(&mut self) -> (bool, egui::FullOutput) {
